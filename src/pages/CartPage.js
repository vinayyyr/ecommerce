    ...
    <Layout loading ={loading}>
      ...
      <Modal show={show} onHide={handleClose}>
        ...
        <Modal.Body><div className="register-form">
          ...
          <input className="form-control" placeholder="pincode" type='number' value={pincode} onChange={(e) => {
            setPincode(e.target.value);
          }} />
          <input className="form-control" placeholder="phonenumber" type='number' value={phonenumber} onChange={(e) => {
            setPhoneNumber
              (e.target.value);
          }} />
